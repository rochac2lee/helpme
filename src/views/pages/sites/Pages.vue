<template>
  <div>
        ...
        <div class="md-layout">
          <div class="md-layout-item md-small-size-100 md-size-30">
            <md-field>
              ...
              <md-input v-model="pages.title" type="text"></md-input>
            </md-field>
          </div>
          <div class="md-layout-item md-small-size-100 md-size-30">
            <md-field>
              <label>Caminho</label>
              <md-input v-model="pages.href" type="text"></md-input>
            </md-field>
          </div>
          <div class="md-layout-item md-small-size-100 md-size-100">
            <md-field maxlength="5">
              <label>Descrição</label>
              <md-textarea v-model="pages.description"></md-textarea>
            </md-field>
          </div>
          <div class="switch md-layout-item md-small-size-100 md-size-20">
            <label>Status</label><br />
            <md-switch v-model="pages.status">{{
              status(pages.status)
            }}</md-switch>
          </div>
          <div class="switch md-layout-item md-small-size-100 md-size-20">
            <label>Abrir em nova aba</label>
            <md-switch value="_blank" v-model="pages.target">{{
              target(pages.target)
            }}</md-switch>
          </div>
    ...
    <div class="md-layout md-gutter md-content">
      <div
        class="md-layout-item contentCard"
        :class="{ 'md-size-100': !viewComponent, 'md-size-25': viewComponent }"
      >
          ...
          <md-card-content>
            <div class="md-layout md-gutter md-content">
              <div class="md-layout-item md-size-100">
                <md-table>
                  <md-table-row>
                    <md-table-head v-if="!viewComponent">Ordem</md-table-head>
                    <md-table-head>Página</md-table-head>
                    <md-table-head v-if="!viewComponent"
                      >Descrição</md-table-head
                    >
                    <md-table-head v-if="!viewComponent">Status</md-table-head>
                    <md-table-head v-if="!viewComponent" class="textCenter"
                      >Ações</md-table-head
                    >
                  </md-table-row>
                  <md-table-row v-for="page in pages" :key="page.id">
                    <md-table-cell class="textCenter" v-if="!viewComponent">
                      <md-button
                        class="md-icon-button"
                        md-menu-trigger
                        @click="up(page)"
                    ...
                    <md-table-cell v-if="!viewComponent">{{
                    ...
                    <md-table-cell v-if="!viewComponent"
                      ...
                      ></md-table-cell
                    >
                    <md-table-cell class="textRight" v-if="!viewComponent">
                      <md-button
                        v-if="page.target != '_blank'"
                        class="md-icon-button"
                        md-menu-trigger
                        @click="viewPageComponent(page)"
                      >
...
export default {
  ...
  data() {
    return {
      title: "Páginas",
      subtitle: "Aqui você pode adicionar quantas páginas quiser.",
  ...
  methods: {
    ...
    viewPageComponent(page) {
      console.log(page);
      (this.viewComponent = true),
        (this.pages = page),
        (this.subtitle = "Editar Componentes");
    },

    hidePageComponent() {
      (this.viewComponent = false),
        (this.subtitle = "Aqui você pode adicionar quantas páginas quiser.");
    },
